...
### **Software Engineer Intern — Globamit**  
📅 *May 2024 – Aug 2024*  
- Developed and deployed scalable **Java-based backend services**.  
- Built **Jenkins CI/CD pipelines** for automated testing, container image builds, and deployment.  
- Designed **REST API integrations** for microservice communication.  
- Used **AWS EC2, S3, IAM** to support cloud-hosted systems.

### **Senior Support Advisor — Kelly Services (Apple, Inc.)**  
📅 *Feb 2021 – Aug 2025*  
- Delivered macOS/iOS technical support with **90%+ first-contact resolution**.  
- Troubleshot escalated issues and worked with **Apple engineering teams**.  
- Mentored junior advisors and improved overall troubleshooting performance.
...
### **🔍 Anomaly Detection System for Pump Failures (2025)**  
Developed a predictive analytics system with SitePro for real-time monitoring and failure detection.

### **🔐 Username & Password Generator (Java)**  
Created a secure credential generation utility with validation, hashing, encryption, and randomized logic.
